...
import { buttonDependencies, buttonImplementationCode } from '../src/constants/button';
    ...
    docs: {
      page: () => (
        <CustomDocsPage
          ...
          installationDeps={buttonDependencies}
          implementationCode={buttonImplementationCode}
        />
      ),
      description: {
