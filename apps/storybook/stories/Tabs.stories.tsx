...
Tabs 컴포넌트는 함께 작동하는 여러 하위 컴포넌트로 구성됩니다:

### 주요 컴포넌트
- \`Tabs\` - 상태 관리를 위한 React Context 제공자가 있는 루트 컨테이너
- \`TabsList\` - 애니메이션 밑줄 인디케이터가 있는 탭 트리거 컨테이너
- \`TabsTrigger\` - 밑줄 스타일용 개별 탭 버튼
- \`TabsTriggerPills\` - Pills 스타일용 개별 탭 버튼
- \`TabsContent\` - 해당 탭이 활성화될 때 표시되는 콘텐츠 패널
...
- **커스텀 브랜드 색상**: \`#271fe0\`으로 커스터마이징된 활성 탭 색상
...
const underlineTabsData = [
  {
    ...
    label: 'Account',
    title: 'Account',
    content: 'Account overview content goes here.',
    disabled: false,
  },
  {
    value: 'tab2',
    label: 'Password',
    title: 'Password',
    content: 'Change or update your password settings.',
    disabled: false,
  },
  {
    value: 'tab3',
    label: 'Settings',
    title: 'Settings',
    content: 'Adjust your application settings here.',
    disabled: false,
  },
  {
    value: 'tab4',
