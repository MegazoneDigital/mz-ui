// Button Component Implementation Code
export const buttonImplementationCode = `import { Slot } from '@radix-ui/react-slot';
...
export const buttonDependencies = ['@radix-ui/react-slot', 'class-variance-authority', 'clsx', 'tailwind-merge'];
