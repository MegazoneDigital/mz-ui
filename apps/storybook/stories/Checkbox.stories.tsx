...
import { checkboxDependencies, checkboxImplementationCode } from '@/constants';
    ...
    docs: {
      page: () => (
        <CustomDocsPage
          ...
          installationDeps={checkboxDependencies}
          implementationCode={checkboxImplementationCode}
        />
      ),
      description: {
